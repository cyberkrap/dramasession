...
def patch_award_currency_source():
	...
	with open(_LOCK_PATH, "w", encoding="utf-8") as lock:
		...
		import_line = "from files.helpers.award_currency import charge_award, currency_label\n"
		if import_line not in source:
